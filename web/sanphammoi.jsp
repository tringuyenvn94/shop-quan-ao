...
<%
    ...
    int soTrang = SPDao.tinhSoTrangDSSPMoi(soLuongTrenTrang);
    request.setAttribute("trang", trang);
    request.setAttribute("soTrang", soTrang);
    
    ArrayList<SPPojo> dsSP = SPDao.layDSSPMoi(trang, 10);
    request.setAttribute("dsSP", dsSP);
    
    request.setAttribute("trangHienTai", "sanphammoi.jsp?mnu=1");
