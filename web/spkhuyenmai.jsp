...
<%
    ...
    int soTrang = SPDao.tinhSoTrangDSSPKhuyenMai(soLuongTrenTrang);
    request.setAttribute("trang", trang);
    request.setAttribute("soTrang", soTrang);
    
    ArrayList<SPPojo> dsSP = SPDao.layDSSPKhuyenMai(trang, 10);
    request.setAttribute("dsSP", dsSP);
    
    request.setAttribute("trangHienTai", "spkhuyenmai.jsp?mnu=2");
